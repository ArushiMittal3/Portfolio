    ...
    <footer className="bg-gray-900 text-[#D1F2EB] py-12 px-4 mt-20 w-full">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="flex gap-4">
              <a href="https://github.com/ArushiMittal3" className="text-[#D1F2EB] hover:text-white transition-colors">
                <FaGithub size={24} />
              </a>
              <a href="https://www.linkedin.com/in/arushi-mittal-1950a3211/" className="text-[#D1F2EB] hover:text-white transition-colors">
                <FaLinkedin size={24} />
              </a>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-[#D1F2EB]/60">
          <p>© {new Date().getFullYear()} Arushi Mittal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
