  ...
  return (
    <div id='hero' className='pb-20 pt-36'>
      ...
      <div>
        ...
        />
        <Spotlight
          className='top-50 -left-0 h-[80vh] w-[60vw]'
          fill='#117A65'
        />
      </div>
      ...
      <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          ...
          <p className='text-center md:tracking-wider mb-4 text-md  text-textSecondary'>
            MCA @ NIT Kurukshetra | Ex-iHub-AWaDH BioFieldPower Intern, IIT
            Ropar | Student Placement Coordinator | Bridging innovation and
            leadership
          </p>
