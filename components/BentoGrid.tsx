...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        `group/bento shadow-input flex flex-col justify-between space-y-4 rounded-3xl relative border-green/[0.6] transition duration-200 hover:shadow-xl dark:shadow-none ${
          id !== 2 && 'overflow-hidden'
        }`,
        className
      )}
      style={{
